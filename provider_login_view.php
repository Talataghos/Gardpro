...
<body>
    ...
    <div class="login-container">
        <div class="login-card">
            ...
            <form action="provider_page.php" class="login-form" id="loginForm" novalidate>
                <div class="smart-field" data-field="email">
                    <div class="field-background"></div>
                    <input type="email" id="email" name="p_email" required autocomplete="email">
                ...
                <div class="smart-field" data-field="password">
                    <div class="field-background"></div>
                    <input type="password" id="password" name="p_password" required autocomplete="current-password">
