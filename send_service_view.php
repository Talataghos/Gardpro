...
<div class="smart-field" data-field="email">
                    ...
                    <input type="email" id="email" name="event" required autocomplete="email">
                ...
                <div class="smart-field" data-field="email">
                    <div class="field-background"></div>
                    <input type="text" id="email" name="service" required autocomplete="email">
