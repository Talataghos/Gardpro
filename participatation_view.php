    ...
    <div class="login-container">
        <div class="login-card">
            ...
            <div class="login-header">
                ...
                <h1>participatation</h1>
            </div>
            
            <form action="<?php echo ($_SERVER["PHP_SELF"]);?>" method="post" class="login-form" id="loginForm" novalidate>
                <div class="smart-field" data-field="email">
                    <div class="field-background"></div>
                    <input type="text" id="email" name="participant" required autocomplete="email">
                    <label for="email">participant</label>
                ...
                <div class="smart-field" data-field="password">
                    <div class="field-background"></div>
                    <input type="text" id="password" name="event" required autocomplete="current-password">
                ...
                <button type="submit" class="neural-button" name="add">
