...
<div class="wrapper">
    ...
    <div class="right">
        <div class="menu">
            <a href="admin_login_view.php">organizer login</a>
            <hr>

            <a href="admin_signup_view.php">organizer signup</a>
            <hr>

            <a href="participant_login_view.php">participant login</a>
            <hr>

            <a href="participant_signup_view.php">participant signup</a>
            <hr>

            <a href="guest_page.php">guest</a>
            <hr>

            <a href="provider_login_view.php">provider login</a>
        </div>
    </div>
